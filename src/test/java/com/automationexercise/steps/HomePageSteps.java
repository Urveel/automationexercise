...
public class HomePageSteps {
    ...
    public void verifyThatIsVisible(String expectedText) {
        Assert.assertEquals(new HomePage().getTextAfterScrollDown(expectedText), expectedText, expectedText + "is not matched");
    }
    ...
    public void clickOnArrowAtBottomRightSideToMoveUpward() {
        Assert.assertTrue(new HomePage().clickOnArrowBtn(), "scroll not working after click on up arrow button");
    }
